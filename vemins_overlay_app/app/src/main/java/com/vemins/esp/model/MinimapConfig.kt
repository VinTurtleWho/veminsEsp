...
data class MinimapConfig(
    ...
    val mapPosX: Float = 0.0f,
    val mapPosY: Float = 0.0f,
    val mapWidth: Float = 342.0f,
    val mapHeight: Float = 342.0f,
    val mapAlpha: Float = 0.0f,
    val rotationDegrees: Float = 315.0f,
    val radarZoom: Float = 2.0f,
    ...
    val usePerspective: Boolean = false,
    ...
    val minimapHeroDotRadius: Float = 16.0f,
